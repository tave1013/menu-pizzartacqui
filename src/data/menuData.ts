...
const picassoImg = "/assets/food/Picasso con basilico.webp";
...
export const menuCategories: Category[] = [
    ...
    items: [
      {
        id: "ai-formagi",
        name: "Ai formaggi",
        desc: "Fiordilatte, gorgonzola, stracchino, toma piemontese",
        price: 9.5,
        image: formaggiImg,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "pugliese",
        name: "Pugliese",
        desc: "Pomodoro, fiordilatte, cipolle",
        price: 7.5,
        image: puglieseImg,
        dietaryTags: ["vegetarian"],
        allergens: ["Glutine", "Lattosio"],
      ...
      },
      {
        id: "wurstel",
        name: "Würstel",
        desc: "Pomodoro, fiordilatte, würstel",
        price: 7.5,
        image: wurstelImg,
        allergens: ["Glutine", "Lattosio"],
        contact: { tel: "+39 3669904236", mail: "info@pizzartacquiterme.com" },
  ...
  },
  {
    ...
    items: [
      {
        id: "panache-piccola-bionda",
        name: "Panaché Piccola Bionda",
        desc: "Birra e gazzosa",
        price: 4.0,
      ...
      {
        id: "panache-media-bionda",
        name: "Panaché Media Bionda",
        desc: "Birra e gazzosa",
        price: 6.0,
      ...
      {
        id: "panache-piccola-rossa",
        name: "Panaché Piccola Rossa",
        desc: "Birra e gazzosa",
        price: 5.0,
      ...
      {
        id: "panache-media-rossa",
        name: "Panaché Media Rossa",
        desc: "Birra e gazzosa",
        price: 7.0,
