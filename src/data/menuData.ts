...
export const menuCategories: Category[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: "raffinata",
        name: "Raffinata",
        desc: "Pomodoro, fior di latte, prosciutto crudo fuori cottura, stracciatella di burrata, pomodorini datterini e rucola",
        price: 13.0,
        image: raffinataImg,
        allergens: ["Glutine", "Lattosio"],
        contact: { tel: "+39 3914272540", mail: "info@pizzartacquiterme.com" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "da-vinci",
        name: "Da Vinci",
        desc: "fior di latte, gamberetti*, rucola, emulsione agli agrumi, glassa di aceto balsamico",
        price: 15.0,
        image: daVinciImg,
